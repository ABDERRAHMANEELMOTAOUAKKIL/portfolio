...
import qeralogo from '../images/match_pointt_logo.jpg'
            ...
            <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
              ...
              <li className="flex gap-4" >
                  ...
                  <dl className="flex flex-auto flex-wrap gap-x-2">
                    ...
                    <Link to="https://www.qerapp.com/" target='_blank' className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:underline">
                    <dd >Match Point - Qera</dd>
                    </Link>                     
                    <dt className="sr-only">Role</dt>
                    <dd className="text-xs text-zinc-500 dark:text-zinc-400">Front-end Mobile developer</dd>
                    <dt className="sr-only">Date</dt>
                    <dd className="ml-auto text-xs text-zinc-400 dark:text-zinc-500" aria-label="2014 until 2019">
                      <time dateTime="2014">Jul-2025</time> <span aria-hidden="true">—</span> <time dateTime="2019">Dec-2025</time>
                    </dd>
                  </dl>
                </li>
                ...
                <li className="flex gap-4" >
                  ...
                  <dl className="flex flex-auto flex-wrap gap-x-2">
                    <dt className="sr-only">Company</dt>
                    <Link to="https://www.yanvision.ma/" target='_blank' className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:underline">
                    <dd >Yanvision</dd>
                    </Link>
                    <dt className="sr-only">Role</dt>
