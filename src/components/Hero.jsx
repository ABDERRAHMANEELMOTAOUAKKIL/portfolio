...
// import image1 from '../images/profile.jpg'; // Make sure the path is correct
      ...
      <div className="mx-auto max-w-2xl lg:max-w-5xl">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            <a className="group -m-1 p-1" aria-label="Follow on LinkedIn" href="https://www.linkedin.com/in/abderrahmane-elmotaouakkil-3a23241a3/" target="_blank" rel="noreferrer" >
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"
